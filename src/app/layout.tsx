...
export const metadata: Metadata = {
  ...
  description:
    "Full-Stack Developer specializing in modern web applications with a focus on user experience and clean code.",
  keywords: [
...
export default function RootLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning className="dark">
      ...
      <body
        className={`${inter.variable} ${manrope.variable} font-sans antialiased bg-[#0a0b0c] text-base`}
      >
        <Providers>
        ...
        <Script id="performance-improvements" strategy="afterInteractive">
          {`
