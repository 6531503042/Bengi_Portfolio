...
export const projects: IProjectItem[] = [
  ...
  {
    id: "bengi-investment",
    title: "Bengi Investment",
    description: "full system include websocket, kafka, real-time price stock, mobile with beautiful ui and user-friendly",
    icons: [
      "/skills/react-native.svg",
      "/skills/go.svg",
      "/skills/tailwind.png",
    ...
    githubUrl: "https://github.com/6531503042/Bengi-Investment-System",
    tags: [
      "React Native",
      "Redis",
      "Go",
    ...
    image: "/projects/bengi-investment/Bengi Investment Banner.png",
    screenshots: [
      "/projects/bengi-investment/Homepage.png",
      "/projects/bengi-investment/market.png",
      "/projects/bengi-investment/Trade.png",
      "/projects/bengi-investment/Portfolio.png",
      "/projects/bengi-investment/Options.png",
      "/projects/bengi-investment/Search.png",
    ],
    technologies: [
      { name: "React Native", icon: "/skills/react-native.svg" },
      { name: "MongoDB", icon: "/skills/mongodb.svg" },
